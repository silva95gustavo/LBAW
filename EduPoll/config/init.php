<?php
	  ...
	  //setcookie(session_name(),session_id(),time() + (365 * 24 * 60 * 60), '/~up2013005803/LBAW');
	  error_reporting(E_ERROR | E_WARNING); // E_NOTICE by default
	   
	  $BASE_DIR = '/opt/lbaw/lbaw1565/public_html/final/';
	  //$BASE_DIR = '/usr/users2/mieic2013/up201305803/public_html/LBAW/';
	  $BASE_URL = '/~lbaw1565/final/';
	  //$BASE_URL = '/~up201305803/LBAW/';
